...
disp('PCS:');
disp(['Avg. planning runtime: ' num2str(Td*1e3) ' msec +/- ' num2str(Td_std*1e3) ' msec.']);
disp(['Avg. computation time of of a path: ' num2str(Tt*1e3) ' msec +/- ' num2str(Tt_std*1e3) ' msec.']);
disp(['Minimal computation of a path: ' num2str(Tm*1e3) ' msec.']);
disp(['t_{real}/t_{min} = ' num2str(Td/Tt)]);
...
disp('GD:');
disp(['Avg. planning runtime: ' num2str(Tg*1e3) ' msec +/- ' num2str(Tg_std*1e3) ' msec.']);
disp(['Avg. computation time of of a path: ' num2str(Tt*1e3) ' msec +/- ' num2str(Tt_std*1e3) ' msec.']);
disp(['Minimal computation of a path: ' num2str(Tm*1e3) ' msec.']);
disp(['t_{real}/t_{min} = ' num2str(Tg/Tt)]);
disp(['Avg. path length: ' num2str(L)]);
disp(['An avg. of ' num2str(IKc) ' projections were made in avg. time of ' num2str(IKt*1e3) ' msec.']);
disp(['An avg. of ' num2str(LCc) ' local connections were checked in avg. time of ' num2str(LCt*1e3) ' msec.']);
disp(['Avg. number of milestones: ' num2str(numMilestones)]);
