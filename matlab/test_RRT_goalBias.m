% In this experiment I test the goalBias value of the RRT and its affect on the
% runtime
% With this planning query:
...
% This while benchmarking the goalBias value.
% Max step size defined for the GD: 2.7
...
%%
D2 = load('test_RRT_GD_3poles_rangeB_goalBias.txt'); 
...
disp(['Minimum avg. runtime for GD is ' num2str(tgmin) 'msec with goalBias = ' num2str(rg(ig)) ]);
