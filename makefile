...
CPP_P_PCS = ${INC_RUN}plan_PCS.cpp ${INC_PLANNERS}CBiRRT_PCS.cpp ${INC_PLANNERS}RRT_PCS.cpp
CPP_P_PCS_s = ${INC_RUN}plan_PCS.cpp ${INC_PLANNERS}CBiRRT_PCS_s.cpp
CPP_P_GD = ${INC_RUN}plan_GD.cpp ${INC_PLANNERS}CBiRRT_GD.cpp ${INC_PLANNERS}RRT_GD.cpp
