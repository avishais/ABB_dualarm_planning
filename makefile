...
CPP_P_SG = ${INC_RUN}plan_SG.cpp ${INC_PLANNERS}CBiRRT_SG.cpp ${INC_PLANNERS}RRT_SG.cpp #${INC_PLANNERS}LazyRRT_SG.cpp ${INC_PLANNERS}SBL_SG.cpp #${INC_PLANNERS}PRM_PCS.cpp 
