...
int main() {
	...
	std::ofstream f;
	f.open("/home/avishai/Downloads/omplapp/ompl/Workspace/ckc3d/tests/results/pcs_rbs_verification_withObs_d.txt", ios::app); //_env2_distMix
	...
	while (i < N) {
		...
		int ik_sol = ik1[active_chain]; //rand() % 8;
